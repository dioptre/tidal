...
d12 $ stack [
  ...
  s "gretsch:0*4" # gain 1.1,
  s "[~ gretsch:4]*2" # gain 0.95,
  s "gretsch:12*8" # gain 0.75,
  
  -- Warm Chords on SuperPiano (8-cycle sheet music progression)
  s "superpiano" # note "<[g4'maj*4] [g4'maj*4] [g4'maj g4'maj c4'maj7 a4'seven] [g4'maj g4'maj c4'maj g4'maj] [a4'min7 g4'maj d4'seven d4'seven] [g4'maj*4] [d4'seven*4] [g4'maj*4]>" # sustain 2.5 # gain 0.85,
