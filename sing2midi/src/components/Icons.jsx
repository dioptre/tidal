...
export const MicIcon = ({ size = 18, color = "#fff", ...props }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" {...defaultProps} stroke={color} {...props}>
...
export const BotIcon = ({ size = 18, color = "#fff", ...props }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" {...defaultProps} stroke={color} {...props}>
    <Path d="M12 8V4H8" />
...
export const GithubIcon = ({ size = 18, color = "#fff", ...props }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" {...defaultProps} stroke={color} fill={color} strokeWidth={0} {...props}>
