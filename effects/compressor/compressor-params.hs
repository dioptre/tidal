...
let compressmix = pF "compressmix"
...
let multibandmix = pF "multibandmix"
...
let glueCompress = compress 0.3 # compressthresh 0.6 # compressratio 2 # compressattack 0.01 # compressrelease 0.1 # compressmakeup 1.2

-- Punchy drum compression
let punchyCompress = compress 0.5 # compressthresh 0.4 # compressratio 4 # compressattack 0.005 # compressrelease 0.05 # compressmakeup 1.3

-- Heavy limiting for loudness
let heavyLimit = compress 0.7 # compressthresh 0.3 # compressratio 10 # compressattack 0.001 # compressrelease 0.05 # compressmakeup 1.5

-- Classic sidechain pump (EDM/French house style)
let pump = sidechain 0.8 # sidechainratio 6 # sidechainattack 0.01 # sidechainrelease 0.2

-- Transparent vocal compression
let vocalCompress = compress 0.4 # compressthresh 0.5 # compressratio 3 # compressattack 0.01 # compressrelease 0.1 # compressknee 0.8

-- Bass control with multiband
let tightBass = multiband 0.5 # multibandlowratio 6 # multibandmidratio 3 # multibandhighratio 2 # multibandlowfreq 150
